...
def clean_ingredients(dish_name, dish_ingredients):
    ...
    """
    my_tuple = (dish_name, set(dish_ingredients))
    return my_tuple
...
def tag_special_ingredients(dish):
    ...
    dish_name = dish[0]
    special_ingredients = SPECIAL_INGREDIENTS & set(dish[1])
    return clean_ingredients(dish_name, special_ingredients)
...
def separate_appetizers(dishes, appetizers):
    ...
    """
    my_dishes = set(dishes)
    my_appetizers = set(appetizers)
    my_set = my_dishes.difference(my_appetizers)
...
def singleton_ingredients(dishes, intersection):
    ...
    # singleton_ing = ingredients & intersection
    return intersection.symmetric_difference(ingredients)
